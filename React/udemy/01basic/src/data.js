...
export const EXAMPLES = {
  ...
  function Welcome() {
    ...
    jsx: {
        title: 'JSX',
        description: 'JSX is a syntax extension to JavaScript. It is similar to a template language, but it has the full power of JavaScript (e.g., it may output dynamic content).',
        code: `
  <div>
